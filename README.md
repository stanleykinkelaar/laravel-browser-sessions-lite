# This is my package laravel-browser-sessions-lite
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-browser-sessions-lite.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-browser-sessions-lite)
...
```bash
php artisan vendor:publish --tag="laravel-browser-sessions-lite-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-browser-sessions-lite-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-browser-sessions-lite-views"
```

## Usage

```php
$laravelBrowserSessionsLite = new Stanley Kinkelaar\LaravelBrowserSessionsLite();
echo $laravelBrowserSessionsLite->echoPhrase('Hello, Stanley Kinkelaar!');
```
